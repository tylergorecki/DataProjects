...
expoints <- function(down, field_pos, togo, pos) {
  ...
  field_pos <- field_pos + gained # add yards gained if played out
...
fb19 <- read.csv('2019 PFF All Plays.csv')
...
# code runs
exp_4_10_64_actual_fg <- mean(replicate(10000,expoints(4,64,10,1)))
